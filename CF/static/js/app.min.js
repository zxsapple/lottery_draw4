$(function() {
	...
	var i = 0,
		...
		m = [
			...
			// ],
			["晚饭",
				"煲仔饭 鸡公煲 螺蛳粉 五谷渔粉 酸辣粉 凉面 凉皮 花甲粉 炸鸡 牛肉面 小炒 猪肚鸡 麻辣烫 手撕鸡 猪脚饭 饺子 潮汕汤河粉 肠粉 减肥 意大利面 麦当劳 肯德基 酸菜鱼 拌饭 沙县小吃 黄焖鸡 凉拌菜 馄饨 炒饭 拉面 热干面 麻辣香锅 猪排饭 紫菜包饭"
				.split(" ")
			]
		],
		h =
	...
	m[1][1] = m[2][1], a.on("animationend webkitAnimationEnd", function(t) {
		...
		if (g.toggleClass("playing", !i), i) i = 0, "monster" == w && x.text(u[t(u.length)]), c.text("！"), l.find("span")
			...
			i = 1, k++, 2 == k && e("我就知道你会换一个 ( ͡° ͜ʖ ͡°)"), 5 == k && e("说，你是不是天秤座？Σ( ° △ °|||)︴"), 10 == k && e(
				"你是吃了炫迈吗？(￣△￣；)"), 20 == k && e("难道你是处女座？ (๑•̀ㅂ•́)و✧"), 30 == k && e("再换我可要报警了！( *・ω・)✄╰ひ╯");
